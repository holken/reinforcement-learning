...
def train(policy_lr=1e-2, val_lr=1e-3, hidden_sizes=[32], batch_size=5000, epochs=50, env_type='CartPole-v0'):
    ...
    def update(obs, acts, vals, rews):
        ...
        for i in range(10):
            ...
            batch_loss = get_loss(obs=torch.as_tensor(obs, dtype=torch.float32),
